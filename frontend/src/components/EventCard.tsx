...
import type { EventPreview, EventCreateRequest } from "@/lib/types";
...
export function EventCard({ type = -1, text = "", event, updateEvents }: { type?: number, text?: string, event: EventPreview, updateEvents?: () => void }) {
